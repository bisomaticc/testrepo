...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ao(e,t,n){let r=new Float32Array(go),i=new G(0,1,0);return new ua({name:`SphericalGaussianBlur`,defines:{n:go,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:No(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jo(){return new ua({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:No(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(){return new ua({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:No(),fragmentShader:`
	...
	`}var Po=class extends In{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Xi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function xl({className:e=``}){let t=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let e=t.current;if(!e)return;let n=new Sr,r=new ja,i=new vl({antialias:!0,alpha:!1});i.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),i.domElement.style.display=`block`,i.domElement.style.width=`100%`,i.domElement.style.height=`100%`;let{clientWidth:a,clientHeight:o}=e;i.setSize(a,o),e.appendChild(i.domElement);let s=new ta(2,2),c=new ua({uniforms:{uTime:{value:0},uResolution:{value:new W(a,o)}},vertexShader:yl,fragmentShader:bl}),l=new Ri(s,c);n.add(l);let u=new $a,d=null;function f(){c.uniforms.uTime.value=u.getElapsedTime(),i.render(n,r),d=requestAnimationFrame(f)}d=requestAnimationFrame(f);let p=new ResizeObserver(()=>{let t=e.clientWidth,n=e.clientHeight;t!==0&&n!==0&&(i.setSize(t,n),c.uniforms.uResolution.value.set(t,n))});return p.observe(e),()=>{d&&cancelAnimationFrame(d),p.disconnect(),s.dispose(),c.dispose(),i.dispose(),i.domElement.parentElement&&i.domElement.parentElement.removeChild(i.domElement)}},[]),(0,b.jsx)(`div`,{ref:t,className:`h-full w-full ${e}`,"aria-hidden":`true`})}function Sl(){let e=window.location.hash||``,t=window.location.pathname||``,n=e.match(/^#\/?blogs?(?:\/(.*))?$/i),r=t.match(/^\/?blogs?(?:\/(.*))?$/i);if(n||r&&t!==`/`){let e=(n?n[1]:r?r[1]:``)||``;return{page:`blogs`,slug:e?e.replace(/^\/+|\/+$/g,``):null}}return{page:`home`,slug:null}}function Cl(){let[e,t]=(0,_.useState)(Sl);(0,_.useEffect)(()=>{function e(){t(Sl())}return window.addEventListener(`popstate`,e),window.addEventListener(`hashchange`,e),()=>{window.removeEventListener(`popstate`,e),window.removeEventListener(`hashchange`,e)}},[]);let n=(0,_.useCallback)((e,n)=>{if(e===`blogs`||e===`blog`){let e=n?`#/blogs/${n}`:`#/blogs`;window.history.pushState({},``,e),t({page:`blogs`,slug:n||null}),window.scrollTo({top:0,behavior:`smooth`})}else{let e=n&&n.startsWith(`#`)?n:`#`;window.history.pushState({},``,e),t({page:`home`,slug:null}),n&&n.startsWith(`#`)&&n!==`#`?setTimeout(()=>{document.querySelector(n)?.scrollIntoView({behavior:`smooth`})},80):window.scrollTo({top:0,behavior:`smooth`})}},[]);return(0,_.useEffect)(()=>{if(e.page===`blogs`){if(e.slug){let t=L.find(t=>t.slug===e.slug);document.title=t?`${t.title} | Blogs`:`Blogs | Rahul Pareek`}else document.title=`Blogs | Rahul Pareek`}else document.title=`Rahul Pareek - Portfolio`},[e]),(0,b.jsxs)(`div`,{className:`relative min-h-screen bg-[#021208]`,children:[(0,b.jsx)(xl,{className:`pointer-events-none fixed inset-0 z-0`}),(0,b.jsxs)(`div`,{className:`relative z-10 flex min-h-screen flex-col justify-between`,children:[(0,b.jsx)(x,{currentRoute:e,onNavigate:n}),(0,b.jsx)(`main`,{className:`flex-1`,children:e.page===`blogs`?(0,b.jsx)(xe,{initialSlug:e.slug,onNavigateHome:()=>n(`home`),onSelectPost:e=>n(`blogs`,e)}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(S,{}),(0,b.jsx)(O,{}),(0,b.jsx)(A,{}),(0,b.jsx)(be,{}),(0,b.jsx)(Se,{})]})}),(0,b.jsx)(R,{currentRoute:e,onNavigate:n})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,b.jsx)(_.StrictMode,{children:(0,b.jsx)(Cl,{})}));